...
def print_repeatedly(string, reptitions):
    count = 0
    while reptitions >= count:
        print(string, end="")
        count += 1
    print()
def print_pattern(string, reptitions_list):
    count = 0
    while count < len(reptitions_list):
        print_repeatedly(string, reptitions_list[count])
        count += 1
